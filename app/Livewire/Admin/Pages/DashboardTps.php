...
class DashboardTps extends Component
{
    ...
    public function mount()
    {
        ...
        $datachartBupati = Hasil::select('kecamatan', DB::raw('SUM(b_1) as total_b1'), DB::raw('SUM(b_2) as total_b2'), DB::raw('SUM(b_ts) as total_bts'))
            ->groupBy('kecamatan')
            ->get();
        ...
        $datachartGubernur = Hasil::select('kecamatan', DB::raw('SUM(g_1) as total_g1'), DB::raw('SUM(g_2) as total_g2'), DB::raw('SUM(g_ts) as total_gts'))
            ->groupBy('kecamatan')
            ->get();
